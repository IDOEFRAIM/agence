...
import { LayoutGrid, PieChart, Users, Globe, LogOut, FileText, Settings, Bell, Archive, ChevronLeft, ChevronRight } from "lucide-react";
  ...
  return (
      <aside className={cn(
         ...
         <button 
            ...
            className="absolute -right-3 top-10 bg-white border border-slate-100 shadow-sm rounded-full p-1.5 text-slate-400 hover:text-blue-600 z-50 hover:shadow-md transition-all"
         >
